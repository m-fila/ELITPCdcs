...
void opcQObject::addMonitoredItem(UA_NodeId VariableId, UA_CreateSubscriptionResponse response, void (*ValueChangedCallback)(UA_Client *, UA_UInt32, void *, UA_UInt32, void *, UA_DataValue *), UA_Double sampling){
