...
public:
    dt1415_variable(std::string ObjectName,std::string VariableName): caen_variable(ObjectName,VariableName,8){}
};

class n1471_variable: public caen_variable{
public:
    n1471_variable(std::string ObjectName,std::string VariableName): caen_variable(ObjectName,VariableName,4){}
};
