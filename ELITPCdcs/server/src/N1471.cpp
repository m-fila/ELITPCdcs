...
N1471::N1471()
    : GenericDevice(ConnectionType::TCP, ConnectionType::TCP),
      moduleAddress(0) {}
...
std::string N1471::sendN1471command(CMD command, CHANNEL channel,
...
std::string N1471::extractCommandStatus(std::string command) { return "OK"; }
