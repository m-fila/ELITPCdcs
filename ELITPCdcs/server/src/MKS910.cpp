...
std::string MKS910::getRelaySafetyDelay() {
  return sendWithDelayedResponse("SPD?");
}

void MKS910::setRelayDirection(MKS910::RelayNo i,
                               MKS910codes::RelayDirection dir) {
  sendWithDelayedResponse("SD" + std::to_string(static_cast<int>(i)) + "!"+MKS910codes::relayDirectionToString.at(dir));
}
