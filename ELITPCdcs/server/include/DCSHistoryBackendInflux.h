...
void setConnetionAddress(std::string address,int port){db.setConnectionParameters(address,port);}
void setUser(std::string userName, std::string password){db.setUser(userName);db.setPassword(password);}
...
static UA_StatusCode serverSetHistoryData(UA_Server *server, void *context,
                               const UA_NodeId *sessionId, void *sessionContext,
                               const UA_NodeId *nodeId, UA_Boolean historizing,
                               const UA_DataValue *value);

static size_t resultSize(UA_Server *server, void *context,
                         const UA_NodeId *sessionId, void *sessionContext,
                         const UA_NodeId *nodeId, size_t startIndex,
                         size_t endIndex);

static size_t getEnd(UA_Server *server, void *context,
                     const UA_NodeId *sessionId, void *sessionContext,
                     const UA_NodeId *nodeId);

static size_t lastIndex(UA_Server *server, void *context,
                        const UA_NodeId *sessionId, void *sessionContext,
                        const UA_NodeId *nodeId);

static size_t firstIndex(UA_Server *server, void *context,
                         const UA_NodeId *sessionId, void *sessionContext,
                         const UA_NodeId *nodeId);
...
copyDataValues(UA_Server *server, void *context, const UA_NodeId *sessionId,
...
static UA_StatusCode
removeDataValue(UA_Server *server, void *hdbContext, const UA_NodeId *sessionId,
                void *sessionContext, const UA_NodeId *nodeId,
