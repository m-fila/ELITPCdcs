#ifndef DT1470ETCODES_H
#define DT1470ETCODES_H
#include <map>
#include <string>

namespace DT1470ETcodes {
...
static std::map<ChannelStatus, std::string> channelStatusToString = {
    ...
    {ChannelStatus::UNV, "UNV"},     {ChannelStatus::MAXV, "MAXV"},
    {ChannelStatus::TRIP, "TRIP"},   {ChannelStatus::OVP, "OVP"},
    {ChannelStatus::OVT, "OVT"},     {ChannelStatus::DIS, "DIS"},
    {ChannelStatus::KILL, "KILL"},   {ChannelStatus::ILK, "ILK"},
    {ChannelStatus::NOCAL, "NOCAL"}, {ChannelStatus::UNKNOWN, "UNKNOWN"}};
