...
enum class Units { MBAR, TORR, PASCAL, MICRON, HPASCAL, VOLT };

static std::map<Units, std::string> unitsToString = {
    {Units::MBAR, "MBAR"},     {Units::TORR, "TORR"},       {Units::PASCAL, "PASCAL"},
    {Units::MICRON, "MICRON"}, {Units::HPASCAL, "HPASCAL"}, {Units::VOLT, "VOLT"},
};
