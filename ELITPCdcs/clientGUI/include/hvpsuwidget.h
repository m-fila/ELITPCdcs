...
protected:
    ...
    std::vector<QLCDNumber*> allTabCHvoltage=std::vector<QLCDNumber*>(channelsNumber+1);;
    std::vector<KLed*> allTabLed=std::vector<KLed*>(channelsNumber+1);
    std::vector<QPushButton*> allTabKill=std::vector<QPushButton*>(channelsNumber+1);
    std::vector<QLabel*> allTabVset=std::vector<QLabel*>(channelsNumber+1);
    std::vector<QPushButton*> allTabSetV=std::vector<QPushButton*>(channelsNumber+1);
    ...
    std::vector<QPushButton*> tabCHxChangeName= std::vector<QPushButton*>(channelsNumber+1);
